...
def main() -> None:
    ...
    parser.add_argument("--detector", choices=["robust", "isolation_forest", "temporal_ridge", "temporal_tcn"], default="robust")
    parser.add_argument("--temporal-window", type=int, default=60)
